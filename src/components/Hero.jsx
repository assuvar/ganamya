...
const Hero = () => {
    return (
        <>
            ...
            <div className="w-full bg-slate-50 border-t border-b border-gray-100 py-12">
                <div className="max-w-7xl mx-auto px-8 flex flex-col items-center">
                    <h3 className="text-gray-500 font-bold uppercase tracking-widest text-sm mb-8 text-center">
