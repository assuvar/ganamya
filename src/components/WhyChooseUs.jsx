    ...
    return (
        <section className="py-24 bg-gradient-to-r from-[#f5f8ff] via-[#fdfdff] to-[#f5f8ff] border-y border-blue-50/50">
            <div className="max-w-6xl mx-auto px-8">
                <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-center text-gray-900 mb-16 font-serif tracking-wide">
                ...
                <div className="grid md:grid-cols-3 gap-12 text-center">
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <h3 className="font-bold text-lg text-gray-900 mb-3">Industry-Focused</h3>
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <h3 className="font-bold text-lg text-gray-900 mb-3">Placement Ready</h3>
                        <p className="text-gray-500 text-sm leading-relaxed px-4">
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <h3 className="font-bold text-lg text-gray-900 mb-3">Hands-on Learning</h3>
                        <p className="text-gray-500 text-sm leading-relaxed px-4">
