    ...
    return (
        <section id="gallery" className="py-24 bg-white border-t border-gray-100">
            <div className="max-w-7xl mx-auto px-8">
                ...
                <div className="bg-gradient-to-r from-gray-50 to-gray-100 p-8 md:p-12 rounded-3xl flex flex-col items-center justify-center text-center shadow-sm border border-gray-200">
                    ...
                    <p className="text-gray-600 mb-8 max-w-md">Stay updated with our latest events, student achievements, and behind-the-scenes moments.</p>
                    <a
                        href={instaLink}
                        target="_blank"
